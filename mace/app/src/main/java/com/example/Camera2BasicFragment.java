...
public class Camera2BasicFragment extends Fragment
    ...
    private LinearLayout mLlJoint;

    private JointIndicatorView mJointIndicatorView;

    private AppCompatTextView mTvInference;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mLlJoint = view.findViewById(R.id.fragment_camera_ll_joint);
        mTvInference = view.findViewById(R.id.fragment_camera_inference_result_tv);
        if (mJointIndicatorView == null) {
            mJointIndicatorView = new JointIndicatorView(getContext(), new Size(1080, 1920));
            mLlJoint.addView(mJointIndicatorView);
        }
    ...
    private void classifyFrame() {
        ...
        final String textToShow = classifier.classifyFrame(bitmap);
        bitmap.recycle();
        ...
        //Todo joint array 대체
        if (mJointIndicatorView != null && mTvInference != null) {
            getActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    if(classifier.jointInfo != null) {
                        mJointIndicatorView.drawJoint(classifier.jointInfo);
                        mTvInference.setText(getString(R.string.fragment_camera_inference, textToShow));
                    }
                }
            });
        }
