...
//            Ln.e(e, "Exception!");
    ...
    public static void saveBitmap(final Bitmap bitmap) {
        saveBitmap(bitmap, System.currentTimeMillis() + "preview.png");
    }
    ...
    public static void saveBitmap(Bitmap bitmap, final String filename) {
        final String root =
                Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "Debug";
//        Ln.i("Saving %dx%d bitmap to %s.", bitmap.getWidth(), bitmap.getHeight(), root);
...
//                Ln.w("Native YUV -> RGB implementation not found, falling back to Java implementation");
