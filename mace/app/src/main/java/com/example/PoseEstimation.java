...
public abstract class PoseEstimation {
    ...
    protected SparseArray<JointCoordinate> jointInfo = new SparseArray<>();
    ...
    PoseEstimation(Activity activity) throws IOException {
        ...
        Log.d("kernelPath", String.valueOf(kernelPath));
        ...
        /**
         * result -1 load failed
         *        0 load success
         */
        int result = MaceEngineJNI.maceCPMSetAttrs(
                2, 0,
                3, 3,
                kernelPath, "GPU", "cpm_v1");

        Log.i("APPModel", "maceCPMSetAttrs result = " + result);
